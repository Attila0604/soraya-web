/*
  ...
  - C.5.8 lädt nur das Mobile-UX-Stylesheet (c57-mobile-ux.css).
*/
...
(function loadSorayaC57Assets() {
  ...
  function addFix() {
    if (document.querySelector('link[data-soraya-c60="css"]')) return;
    var link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "/c60-fix.css?v=" + VERSION;
    link.setAttribute("data-soraya-c60", "css");
    document.head.appendChild(link);
  }

  function addImages() {
    if (document.querySelector('link[data-soraya-c61="css"]')) return;
    var link = document.createElement("link");
    link.rel = "stylesheet";
    link.href = "/c61-images.css?v=" + VERSION;
    link.setAttribute("data-soraya-c61", "css");
    document.head.appendChild(link);
  }

  function addSwipe() {
    if (document.querySelector('script[data-soraya-c60="js"]')) return;
    var s = document.createElement("script");
    s.src = "/c60-swipe.js?v=" + VERSION;
    s.defer = true;
    s.setAttribute("data-soraya-c60", "js");
